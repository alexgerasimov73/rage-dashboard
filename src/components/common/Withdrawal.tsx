...
export const Withdrawal = ({ amount, chain, decimals, symbol }: Props) => (
  <Root>
    ...
    <Portal>
      ...
      <Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-6 min-w-[480px] p-3 rounded-4 border border-bg-2 bg-bg-trans-grey backdrop-blur-md z-30 data-[state=open]:animate-contentShow">
